        ...
        change = {
            ...
            move: function (ele, zoom, e) {
                ...
                for (var prop in dataset) {
                    dataset2[prop] = dataset[prop];
                }
                dataset2.index = id2;

                var move2 = utils.css(change.possibilities(cssArrIndex, dataset2, leftX, topY, posX, posY));
                //Uncomment to see Index number for collision type

                // And Actual Call
                var zoom2 = {};
                var sel = (zoom.selector === '.zoom-obj-1') ? '.zoom-obj-0' : '.zoom-obj-1';
                for (var prop in zoom) {
                            ...
                            zoomMove = function (e, originalEvent) {
                                ...
                                change.move(ele, zoom, e);
                                    ...
                                    zoomStart = function () {
                                        ...
                                        var others = ele.siblings();
                                        others.bind(uid.move, zoomMove);
